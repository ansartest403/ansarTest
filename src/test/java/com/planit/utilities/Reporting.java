...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/Result/"+repName);//specify location of the report
		...
		htmlReporter.config().setDocumentTitle("planit Project"); // Tile of report
